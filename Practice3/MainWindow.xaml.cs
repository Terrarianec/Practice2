...
namespace Practice3
{
	...
	public partial class MainWindow : Window
	{
		...
		{
			ResultTextBox.Text = $"{SolutionFor3.FindRowWithMaxSimilarItems(_matrix) + 1}";
		}
		...
		private void AboutButtonClick(object sender, RoutedEventArgs e)
		{
			MessageBox.Show(
				...
				"Задание: Дана целочисленная матрица размера M × N. Найти номер последней из ее строк, содержащих максимальное количество одинаковых элементов.",
				"О программе",
				MessageBoxButton.OK,
